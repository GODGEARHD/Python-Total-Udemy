...
print(f"La primera letra de tu texto es {first_letters} y la última es {last_letters}")

# 4 All the words in reverse order.
text_united = "".join(question_1)
reverse = text_united[::-1]

print(f"Todo tu texto al revés se ve así: {reverse}")

# 5 Word 'Python' is on the text
dictionary = {True: "sí está", False: "no está"}
python_word = "python" in question_1.lower()
